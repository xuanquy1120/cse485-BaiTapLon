...
<html lang="en">
  ...
  foreach($list_education as $lists)
  {
    echo'<tr>
            ...
            <td><a href="education_update.php?id='.$lists['id_gd'].'"<i class="far fa-edit"></i></a></td>
            <td><a href="education_delete.php?id='.$lists['id_gd'].'"<i class="fas fa-trash-alt"></i></a></td>
        </tr> ';
  }
  ?>
      ...
      <a href="education_update.php" class="btn btn-success">Thêm mới</a>
      </p>
  </div>
    <!-- Optional JavaScript -->
