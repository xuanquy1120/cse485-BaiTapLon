...
if($link === false){
    ...
    $sql = "SELECT * FROM giaoduc WHERE id_gd  = ?";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Công ty</label>
                        <p class="form-control-static"><?php echo $row["hocvien"]; ?></p>
                    </div>
                    <div class="form-group">
                    ...
                    <p><a href="education.php" class="btn btn-success">Quay lại</a></p>
                </div>
            </div>        
        </div>
    </div>
